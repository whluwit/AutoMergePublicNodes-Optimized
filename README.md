...
| 评分 | 协议 | 延迟(ms) | 来源 |
| --- | --- | --- | --- |
| 83.83 | http | 239.3 | zhangkai |
| 83.69 | http | 245.3 | zhangkai |
| 83.65 | http | 246.8 | zhangkai |
| 83.54 | http | 251.5 | zhangkai |
| 83.53 | http | 252.4 | zhangkai |
...
| Au1rxx-base64 | 0.934 | 428 | prefer |
| Surfboard-tg-mixed | 0.64 | 89 | observe |
| mheidari-all | 0.606 | 9 | observe |
| DeltaKronecker-all | 0.513 | 88 | observe |
