...
| 评分 | 协议 | 延迟(ms) | 来源 |
| --- | --- | --- | --- |
| 84.49 | hysteria2 | 229.8 | Au1rxx-base64 |
| 82.8 | shadowsocks | 225.2 | Au1rxx-base64 |
| 82.7 | shadowsocks | 229.8 | Au1rxx-base64 |
| 82.7 | shadowsocks | 229.8 | Au1rxx-base64 |
| 82.52 | vless | 237.7 | Au1rxx-base64 |

### Top 来源质量

| 来源 | 评分 | 测试数 | 建议 |
| --- | --- | --- | --- |
| Au1rxx-base64 | 1.0 | 350 | prefer |
| zhangkai | 0.967 | 24 | prefer |
| Surfboard-tg-mixed | 0.863 | 155 | prefer |
| DeltaKronecker-all | 0.853 | 117 | prefer |
| mheidari-all | 0.633 | 14 | observe |
