...
| 评分 | 协议 | 延迟(ms) | 来源 |
| --- | --- | --- | --- |
| 82.22 | shadowsocks | 225.1 | Au1rxx-base64 |
| 81.99 | shadowsocks | 234.7 | Au1rxx-base64 |
| 81.37 | vless | 276.8 | Au1rxx-base64 |
| 79.74 | vless | 282.1 | Au1rxx-base64 |
| 79.69 | vless | 395.4 | Au1rxx-base64 |

### Top 来源质量

| 来源 | 评分 | 测试数 | 建议 |
| --- | --- | --- | --- |
| Au1rxx-base64 | 1.0 | 333 | prefer |
| zhangkai | 0.964 | 22 | prefer |
| DeltaKronecker-all | 0.847 | 131 | prefer |
| Surfboard-tg-mixed | 0.831 | 171 | prefer |
| mheidari-all | 0.643 | 10 | observe |
